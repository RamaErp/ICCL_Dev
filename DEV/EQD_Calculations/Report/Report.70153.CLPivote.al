report 70153 "CL Pivote"
{
    ...
    dataset
    {
        dataitem(CMTmLevelLoss; CMTmLevelLoss)
        {
            ...
            begin
                ...
                ExcelBuffer.AddColumn('Sum of Profit (+)/Loss(-) OnScenario1A', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Sum of Profit (+)/Loss(-) OnScenario1B', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Sum of Profit (+)/Loss(-) OnScenario2A', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Sum of Profit (+)/Loss(-) OnScenario2B', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Sum of Profit (+)/Loss(-) OnScenario3', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Sum of Profit (+)/Loss(-) OnScenario4', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
            ...
            begin
                ...
                //   StoreScenarioAnalysis("Client Level Profit Loss")
            end;
        }
    }
    ...
    begin
        ExcelBuffer.NewRow();
        ExcelBuffer.AddColumn('CL Pivote', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
        ExcelBuffer.NewRow();
        ...
        ExcelBuffer.NewRow();
        ExcelBuffer.AddColumn('Details CL Pivote', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
    end;
    ...
    var
        myInt: Integer;
    begin
        ExcelBuffer.CreateNewExcelBookY('', 'CL Pivote', 'CL Pivote', CompanyName, UserId);
    end;
    ...
    local procedure StoreScenarioAnalysis(SourceRec: Record "Client Level Profit Loss")
    var
    ...
    begin
        ...
        if ScenarioAnalysis.FindLast() then
            LastSrNo := ScenarioAnalysis.SrNo + 1
        else
            LastSrNo := 1;

        ScenarioAnalysis.SrNo := LastSrNo;
        ...
        ScenarioAnalysis.Scenario1A := SenPrice1A;
        ScenarioAnalysis.Scenario1B := SenPrice1B;
        ScenarioAnalysis.Scenario2A := SenPrice2A;
        ScenarioAnalysis.Scenario2B := SenPrice2B;
        ScenarioAnalysis.Scenario3 := scenario3;
        ScenarioAnalysis.Scenario4 := scenario4;
