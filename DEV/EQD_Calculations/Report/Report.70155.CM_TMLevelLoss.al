report 70155 "CM-TM Level Loss"
{
    ...
    dataset
    {
        dataitem(CMTmLevelLoss; CMTmLevelLoss)
        {
            ...
            begin
                ...
                ExcelBuffer.AddColumn('Loss(-) OnScenario1A ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario1B ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario2A ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario2B ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario3 ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario4 ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
            ...
            begin
                ...
                ScenarioAnalysis.SetRange("CmCode", CMTmLevelLoss.CmCode);
                ScenarioAnalysis.SetRange("TmCode", CMTmLevelLoss.TmCode);
                // ScenarioAnalysis.SetRange("Client Code", CMTmLevelLoss.ClientCode);
                ...
                // if CMTmLevelLoss.ClientCode = 'OWN' then
                //     NetPLSenPrice1A := SenPrice1A
                // else
                //     NetPLSenPrice1A := CMTmLevelLoss.Margin + SenPrice1A;


                // if CMTmLevelLoss.ClientCode = 'OWN' then
                //     NetPLSenPrice1B := SenPrice1B
                // else
                //     NetPLSenPrice1B := CMTmLevelLoss.Margin + SenPrice1B;

                // if CMTmLevelLoss.ClientCode = 'OWN' then
                //     NetPLSenPrice2A := SenPrice2A
                // else
                //     NetPLSenPrice2A := CMTmLevelLoss.Margin + SenPrice2A;

                // if CMTmLevelLoss.ClientCode = 'OWN' then
                //     NetPLSenPrice2B := SenPrice2B
                // else
                //     NetPLSenPrice2B := CMTmLevelLoss.Margin + SenPrice2B;

                // if CMTmLevelLoss.ClientCode = 'OWN' then
                //     NetPLscenario3 := scenario3
                // else
                //     NetPLscenario3 := CMTmLevelLoss.Margin + scenario3;

                // if CMTmLevelLoss.ClientCode = 'OWN' then
                //     NetPLscenario4 := scenario4
                // else
                //     NetPLscenario4 := CMTmLevelLoss.Margin + scenario4;
                ...
                ExcelBuffer.AddColumn(CMTmLevelLoss.CmCode, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn(CMTmLevelLoss.TmCode, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                // ExcelBuffer.AddColumn(CMTmLevelLoss.ClientCode, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ...
                //end;
                cmcode := CMTmLevelLoss.CmCode;
                TmCode := CMTmLevelLoss.TmCode;
    ...
    begin
        ExcelBuffer.NewRow();
        ExcelBuffer.AddColumn('CM-TM Level Loss', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
        ExcelBuffer.NewRow();
        ...
        ExcelBuffer.NewRow();
        ExcelBuffer.AddColumn('Details CM-TM Level Loss', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
    end;
    ...
    var
        myInt: Integer;
    begin
        ExcelBuffer.CreateNewExcelBookY('', 'CM-TM Level Loss', 'CM-TM Level Loss', CompanyName, UserId);
    end;
