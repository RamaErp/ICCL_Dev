// report 50055 "Client Series Level P&L"
// {
...
//     dataset
//     {
//         dataitem("Final Stress Loss Inputs"; "Final Stress Loss Inputs")
//         {
...
//                 ExcelBuffer.AddColumn('"Net Quantity"', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
...
//                 Clear(scenario6);
//                 BsmOutput.Reset();
//                 BsmOutput.SetRange("Asset Code", "Final Stress Loss Inputs"."Asset Code");
//                 BsmOutput.SetRange("Series ID", "Final Stress Loss Inputs"."Series ID");
//                 if BsmOutput.FindFirst() then begin
//                     if "Final Stress Loss Inputs"."Call/Put" = 'C' then begin
//                         // Call Option
...
//                     end;
//                     // Put Option 
//                     if "Final Stress Loss Inputs"."Call/Put" = 'P' then begin
...
//                     end;
//                     if "Final Stress Loss Inputs"."Call/Put" = 'F' then begin
...
//                     // Clear(Sen1);
//                     // EDX_BC.Reset();
//                     // EDX_BC.SetRange("Series ID", "Final Stress Loss Inputs"."Series Code");
...
//                     // END;
//                     //optionPrice.Reset();
//                     // optionPrice.SetRange("Series ID", "Final Stress Loss Inputs"."Series Code");

//                     Clear(NetValueonTotalClosePrice);
//                     NetValueonTotalClosePrice := "Today Close Price" * "Net Quantity";
...
//                     Clear(Value1);
//                     Value1 := "Net Quantity" * FPSC1A;
//                     Clear(Value2);
//                     Value2 := "Net Quantity" * FPSC1B;
//                     Clear(Value3);
//                     Value3 := "Net Quantity" * FPSC2A;
//                     Clear(Value4);
//                     Value4 := "Net Quantity" * FPSC2B;
//                     Clear(Value5);
//                     Value5 := "Net Quantity" * scenario5;
//                     Clear(Value6);
//                     Value6 := "Net Quantity" * scenario6;
//                     Clear(ProfitLossSC1A);
//                     ProfitLossSC1A := CalculateDifference("Call/Put", "Net Quantity", "Net Value", Value1);
//                     Clear(ProfitLossSC1B);
//                     ProfitLossSC1B := CalculateDifference("Call/Put", "Net Quantity", "Net Value", Value2);
//                     Clear(ProfitLossSC2A);
//                     ProfitLossSC2A := CalculateDifference("Call/Put", "Net Quantity", "Net Value", Value3);
//                     Clear(ProfitLossSC2B);
//                     ProfitLossSC2B := CalculateDifference("Call/Put", "Net Quantity", "Net Value", Value4);
//                     Clear(ProfitLossSC3);
//                     ProfitLossSC3 := CalculateDifference("Call/Put", "Net Quantity", "Net Value", Value5);
//                     Clear(ProfitLossSC4);
//                     ProfitLossSC4 := CalculateDifference("Call/Put", "Net Quantity", "Net Value", Value6);
//                 end;

//                 ExcelBuffer.NewRow;
//                 ExcelBuffer.AddColumn(sr, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs".CmCode, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs".TmCode, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Client Code", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Product Type", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Series ID", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Strike Price", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Call/Put", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Asset Code", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Series Code", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Market Lot", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Underlying ID", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Pre Day Close Price", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Today Close Price", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."CP Code", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Net Quantity", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn("Final Stress Loss Inputs"."Net Value", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
...
//                 ExcelBuffer.AddColumn(scenario5, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                 ExcelBuffer.AddColumn(scenario6, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
...
//                 //StoreScenarioAnalysis("Final Stress Loss Inputs")
...
//         myInt: Integer;
//     begin
//         ExcelBuffer.CreateNewExcelBookY('', 'Client Series Level P&Ll', 'Client Series Level P&L', CompanyName, UserId);
//     end;
...
//     local procedure StoreScenarioAnalysis(SourceRec: Record "Final Stress Loss Inputs")
//     var
//         ScenarioAnalysis: Record FinalStressLossModel;
//         LastSrNo: Integer;
//     begin
...
//         ScenarioAnalysis."Client Code" := SourceRec."Client Code";
//         ScenarioAnalysis."Product Type" := SourceRec."Product Type";
//         ScenarioAnalysis."Series Id" := SourceRec."Series ID";
//         ScenarioAnalysis."Strike Price" := SourceRec."Strike Price";
//         ScenarioAnalysis."Call/Put" := SourceRec."Call/Put";
//         ScenarioAnalysis."Asset Code" := SourceRec."Asset Code";
//         ScenarioAnalysis."Series Code" := SourceRec."Series Code";
//         ScenarioAnalysis."Market Lot" := SourceRec."Market Lot";
//         ScenarioAnalysis."Underlying Id" := SourceRec."Underlying ID";
//         ScenarioAnalysis."Pre Day Close Price" := SourceRec."Pre Day Close Price";
//         ScenarioAnalysis."Today Close Price" := SourceRec."Today Close Price";
//         ScenarioAnalysis."CP Code" := SourceRec."CP Code";
//         ScenarioAnalysis."Net Qty" := SourceRec."Net Quantity";
//         ScenarioAnalysis."Net Value" := SourceRec."Net Value";
...
//         ScenarioAnalysis."Scenario 1A (Increase)" := FPSC1A;
//         ScenarioAnalysis."Scenario 1B (Increase)" := FPSC1B;
//         ScenarioAnalysis."Scenario 2A (Decrease)" := FPSC2A;
//         ScenarioAnalysis."Scenario 2B (Decrease)" := FPSC2B;
//         ScenarioAnalysis."Scenario 3 Price Max" := scenario5;
//         ScenarioAnalysis."Scenario 4 Price Max" := scenario6;
