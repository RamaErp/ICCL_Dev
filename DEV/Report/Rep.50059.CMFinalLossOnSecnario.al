// report 50059 "CM Final Loss On Scenario"
// {
...
//                 finalLossSenario1 := CalculateMaxValue("Client Margin Inputs".FundsPayInPreDay, "Client Margin Inputs".FundsPayOutPreDay, "Client Margin Inputs".FundsPayInAtEODPrice, "Client Margin Inputs".FundsPayOutAtEODPrice, TotalNetLLossenPrice1A, TotalNetLLossSenPrice1B, 0);
//                 finalLossSenario2 := CalculateMaxValue("Client Margin Inputs".FundsPayInPreDay, "Client Margin Inputs".FundsPayOutPreDay, "Client Margin Inputs".FundsPayInAtEODPrice, "Client Margin Inputs".FundsPayOutAtEODPrice, TotalNetLLossSenPrice2A, TotalNetLLossSenPrice2B, 0);
//                 finalLossSenario3 := CalculateNetAmount("Client Margin Inputs".FundsPayInPreDay, "Client Margin Inputs".FundsPayOutPreDay, "Client Margin Inputs".FundsPayInAtEODPrice, "Client Margin Inputs".FundsPayOutAtEODPrice, TotalNetLLossscenario3, 0);
//                 finalLossSenario4 := CalculateNetAmount("Client Margin Inputs".FundsPayInPreDay, "Client Margin Inputs".FundsPayOutPreDay, "Client Margin Inputs".FundsPayInAtEODPrice, "Client Margin Inputs".FundsPayOutAtEODPrice, TotalNetLLossscenario4, 0);
...
//                     ExcelBuffer.AddColumn("Client Margin Inputs".FundsPayInPreDay, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                     ExcelBuffer.AddColumn("Client Margin Inputs".FundsPayOutPreDay, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                     ExcelBuffer.AddColumn("Client Margin Inputs".FundsPayInAtEODPrice, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
//                     ExcelBuffer.AddColumn("Client Margin Inputs".FundsPayOutAtEODPrice, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
