report 70159 "CD_CM-TM Level Loss"
{
    ...
    dataset
    {
        dataitem(CD_CMFinalLossScenario; CD_CMFinalLossScenario)
        {
            ...
            begin
                ...
                ExcelBuffer.AddColumn('Loss(-) OnScenario1AForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario1BForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario2AForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario2BForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario3ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
                ExcelBuffer.AddColumn('Loss(-) OnScenario4ForClientAndOwn', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
            ...
            begin
                ...
                ScenarioAnalysis.SetRange("TmCode", CD_CMFinalLossScenario.TmCode);
                //ScenarioAnalysis.SetRange("Client Code", CD_CMFinalLossScenario.ClientCode);
                ...
                //if (cmCodeNew <> CD_CMFinalLossScenario.CmCode) and (TmCodeNew <> CD_CMFinalLossScenario.TmCode) then begin
                Sr += 1;
                ExcelBuffer.NewRow;
                ...
                // ExcelBuffer.AddColumn(CD_CMFinalLossScenario.ClientCode, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ...
                //end;
                //cmCodeNew := CD_CMFinalLossScenario.CmCode;
                //TmCodeNew := CD_CMFinalLossScenario.TmCode;
            end;
        }
    }
